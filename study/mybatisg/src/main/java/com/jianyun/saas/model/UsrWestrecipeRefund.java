...
public class UsrWestrecipeRefund extends UsrWestrecipeRefundKey {
    ...
    public BigDecimal getUseLevel() {
        return useLevel;
    }

    public void setUseLevel(BigDecimal useLevel) {
